...
public class MainActivity extends Activity {
    ...
    private boolean mustOpenInSafeBrowser(String url) {
        if (url == null) return false;
        String lowerUrl = url.toLowerCase();
        return lowerUrl.contains("accounts.google.com")
                || lowerUrl.contains("/o/oauth2/")
                || lowerUrl.contains("oauth") && lowerUrl.contains("google")
                || lowerUrl.contains("signin") && lowerUrl.contains("google");
    }
    ...
    private void openInExternalBrowser(String url) {
        try {
            ...
            // Si no hay navegador disponible, dejamos que el WebView lo intente.
            webView.loadUrl(url);
        }
    }
